 ...
 */
get('/api/v1/auth/personas', async () =>
  ok(await db.all("SELECT line_user_id, nickname, display_name, role FROM members ORDER BY CASE role WHEN 'owner' THEN 0 WHEN 'helper' THEN 1 WHEN 'packer' THEN 2 ELSE 3 END, nickname")));
